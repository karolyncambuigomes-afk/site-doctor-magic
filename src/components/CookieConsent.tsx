      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 text-sm border border-border rounded hover:bg-muted bg-background text-foreground transition-colors"
          >
            Decline
          </button>
          <button
            onClick={acceptCookies}
            className="px-4 py-2 text-sm bg-luxury-navy text-white rounded hover:bg-luxury-navy/90 transition-colors font-medium"
          >
            Accept
          </button>
        </div>
