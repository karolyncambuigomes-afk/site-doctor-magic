...
export const models: Model[] = [
  {
    ...
    characteristics: ['High Class', 'Bi Sexual', 'Open Minded', 'Young', 'Brunette', 'Slim'],
  ...
  },
  {
    ...
    characteristics: ['High Class', 'Blonde', 'Slim', 'Natural'],
    availability: 'available',
    rating: 4.8,
    reviews: 203,
  ...
  },
  {
    ...
    characteristics: ['High Class', 'Open Minded', 'Young', 'Gym Toned'],
    availability: 'busy',
    rating: 4.9,
    reviews: 89,
  ...
  },
  {
    ...
    characteristics: ['High Class', 'Natural', 'Brunette', 'Slim'],
    availability: 'available',
    rating: 5.0,
    reviews: 124,
  ...
  },
  {
    ...
    characteristics: ['High Class', 'Bi Sexual', 'Party Model', 'Young', 'Baby Face', 'Brunette'],
    availability: 'available',
    rating: 4.9,
    reviews: 78,
  ...
  },
  {
    ...
    characteristics: ['High Class', 'Open Minded', 'Blonde', 'Gym Toned', 'Natural'],
    availability: 'available',
    rating: 4.8,
    reviews: 142,
