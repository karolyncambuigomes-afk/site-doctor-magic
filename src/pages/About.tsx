    ...
    <>
      ...
      <main className="pt-16 bg-white">
          ...
          <section className="py-16 md:py-24 lg:py-32 bg-white">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h1 className="heading-display mb-6 text-black">
                    About Five London
                  </h1>
                  <p className="body-lg text-gray-800 mb-8 leading-relaxed">
                  ...
                  <p className="body-md text-gray-800 leading-relaxed">
            ...
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 lg:order-2">
                  <h2 className="heading-lg mb-6 text-black">Our Story</h2>
                  <p className="body-md text-gray-800 mb-6 leading-relaxed">
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="heading-lg mb-6 text-black">Why Choose Five London</h2>
                <p className="body-lg text-gray-800 max-w-3xl mx-auto leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                {values.map((value, index) => (
                  <div key={index} className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="heading-sm mb-4 text-black">{value.title}</h3>
                    <p className="body-md text-gray-800 leading-relaxed">{value.description}</p>
                  </div>
                ))}
              </div>
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="heading-lg mb-6 text-black">Our Achievements</h2>
                <p className="body-lg text-gray-800 max-w-3xl mx-auto leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {achievements.map((achievement, index) => (
                  <div key={index} className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="heading-sm mb-3 text-black">{achievement.text}</h3>
                    <p className="body-sm text-gray-800 leading-relaxed">{achievement.detail}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="heading-lg mb-8 text-black">Our Commitment to Excellence</h2>
                <div className="space-y-8">
                  <p className="body-lg text-gray-800 leading-relaxed">
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4 text-center">
              <h2 className="heading-lg mb-6 text-black">Ready to Experience Excellence?</h2>
              <p className="body-lg text-gray-800 mb-8 max-w-3xl mx-auto leading-relaxed">
