          ...
          <div className="container-width-lg">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <div className="space-y-4 md:space-y-6 text-muted-foreground">
                <p className="text-xs md:text-sm lg:text-base font-light leading-relaxed">
        ...
        <section className="py-16 md:py-20 bg-muted/10">
          <div className="container-width text-center">
            <div className="max-w-2xl mx-auto space-y-8">
              <h2 className="text-base md:text-lg font-light tracking-[0.2em] uppercase text-foreground">
