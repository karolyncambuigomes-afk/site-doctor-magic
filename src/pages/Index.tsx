        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <details className="mb-8">
              <summary className="cursor-pointer luxury-heading-lg text-center mb-6 hover:text-black transition-colors">
                <h2>About Our Premium Services</h2>
              </summary>
              <div className="grid md:grid-cols-2 gap-8 mt-8">
                <div className="space-y-4">
                  <h3 className="luxury-heading-md text-black">Elite Escort Services London</h3>
                ...
                <div className="space-y-4">
                  <h3 className="luxury-heading-md text-black">Premium London Areas</h3>
                  <div className="space-y-3">
                    <div>
                      <h4 className="luxury-body-sm font-medium text-black">Mayfair W1</h4>
                      <p className="luxury-body-xs text-black">Home to luxury shopping at Bond Street, exclusive dining, and world-class hotels including Claridge's and The Connaught.</p>
                    </div>
                    <div>
                      <h4 className="luxury-body-sm font-medium text-black">Knightsbridge SW1</h4>
                      <p className="luxury-body-xs text-black">Prestigious area near Harrods, Hyde Park, and luxury hotels including The Berkeley and Mandarin Oriental.</p>
                    </div>
                    <div>
                      <h4 className="luxury-body-sm font-medium text-black">Chelsea SW3</h4>
                      <p className="luxury-body-xs text-black">Sophisticated neighbourhood with world-class restaurants, galleries, and exclusive private members' clubs.</p>
                    </div>
                    <div>
                      <h4 className="luxury-body-sm font-medium text-black">Belgravia SW1</h4>
                      <p className="luxury-body-xs text-black">Elite residential area with Georgian architecture, premium boutiques, and Michelin-starred dining venues.</p>
                    </div>
                  </div>
                </div>
              </div>
