...
('booking_info_schedule', '⏰ Schedule', '', 'Available 24/7. We recommend booking at least 2 hours in advance for better availability.', true),
('booking_info_discretion', '🔒 Discretion', '', 'Complete confidentiality guaranteed. All data is protected and never shared.', true),
('booking_info_payment', '💳 Payment', '', 'We accept credit cards, bank transfers and cash. Payment is always discreet and secure.', true),
('booking_info_location', '📍 Location', '', 'We serve all of London. Hotels, private residences or venues of your choice.', true);