-- CRITICAL SECURITY FIX: Remove public access to model_applications table
...
SELECT policy_name, cmd, roles, using_expression, with_check_expression
FROM pg_policies 
...
-- Remove any existing policies and recreate them with strict admin-only access
...
-- Create secure policies using the is_admin() function for consistency
