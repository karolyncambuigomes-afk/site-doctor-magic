-- Create Content Management System with versioning and image optimization
...
CREATE TABLE IF NOT EXISTS public.optimized_images (
    ...
    alt_text TEXT,
    dimensions JSONB DEFAULT '{}', -- {width: number, height: number}
    created_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
    INDEX idx_optimized_images_bucket_path ON optimized_images(bucket_path)
);
