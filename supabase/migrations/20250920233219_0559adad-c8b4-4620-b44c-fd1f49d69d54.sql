...
-- Keep the user insert policy but enhance security checks
...
WITH CHECK (
  ...
  -- Additional security: limit to one application per user per day
  NOT EXISTS (
    SELECT 1 FROM model_applications 
